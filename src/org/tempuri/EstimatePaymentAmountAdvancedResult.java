/**
 * EstimatePaymentAmountAdvancedResult.java
 *
...
public class EstimatePaymentAmountAdvancedResult  extends org.tempuri.BaseEntity  implements java.io.Serializable {
    private org.tempuri.MessageStatus status;

    private org.tempuri.PaymentAmountAdvanced[] listPaymentAmountAdvanced;

    public EstimatePaymentAmountAdvancedResult() {
    }
    ...
    /**
     * Gets the status value for this EstimatePaymentAmountAdvancedResult.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this EstimatePaymentAmountAdvancedResult.
     * 
     * @param status
     */
    ...
    /**
     * Gets the listPaymentAmountAdvanced value for this EstimatePaymentAmountAdvancedResult.
     * 
    ...
    /**
     * Sets the listPaymentAmountAdvanced value for this EstimatePaymentAmountAdvancedResult.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EstimatePaymentAmountAdvancedResult)) return false;
        EstimatePaymentAmountAdvancedResult other = (EstimatePaymentAmountAdvancedResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EstimatePaymentAmountAdvancedResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org", "EstimatePaymentAmountAdvancedResult"));
